...
//------------------------------------------------------------------------------ Movie slider
class GuiMovieSlider : public GuiControl {
public:
	float				pct;
	float				sliderPos;
	float*				value;
	...
	//--------------------------------------------------------------------- movie slider
	GuiMovieSlider(string name, ofVideoPlayer* input) : GuiControl(name) {
		...
		//Buttons
		doPause = false;
		pauseBtn = new GuiButton("Pause", doPause);
		cue1Btn  = new GuiButton("Cue 1", cue_1);
		cue2Btn  = new GuiButton("Cue 2", cue_2);
		resetBtn = new GuiButton("Reset", resetCue);
