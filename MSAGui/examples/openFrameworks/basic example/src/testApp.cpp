...
void testApp::setup(){	 
	...
	// 'gui' is a global variable declared in Gui.h
	...
	// you can override this with GuiPage::setXMLName(string s);
	// Gui::addPage() returns reference to the page, so you can do it directly on one line
